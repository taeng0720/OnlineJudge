    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>158/195</span>
            </div>
...
export const avoidNoCacheable = async &lt;T&gt;(p: Promise&lt;T&gt;) =&gt; {
  try {
    ...
    if (!(e instanceof NoCacheableError)) <span class="branch-0 cbranch-no" title="branch not covered" >throw e;</span>
  }
};
&nbsp;
const getVal = (value: unknown) =&gt; JSON.stringify(value) || '"undefined"';
&nbsp;
const getFullKey = (originalKey: string, keyPrefix?: string) =&gt; `${<span class="branch-0 cbranch-no" title="branch not covered" >keyPrefix? `${keyPrefix}:` : '</span>'}${originalKey}`;
&nbsp;
    ...
    async mset(args, ttl) {
      ...
      if (t !== undefined &amp;&amp; t !== 0) {
        ...
        for (const [key, value] of args) {
          if (!isCacheable(value))
<span class="branch-0 cbranch-no" title="branch not covered" >            throw new NoCacheableError(</span>
<span class="cstat-no" title="statement not covered" >              `"${getVal(value)}" is not a cacheable value`,</span>
...
&nbsp;
// TODO: coverage
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >export async function redisClusterStore(options: RedisClusterOptions &amp; Config) {</span></span>
<span class="cstat-no" title="statement not covered" >  const redisCache = createCluster(options);</span>
<span class="cstat-no" title="statement not covered" >  await redisCache.connect();</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  return redisClusterInsStore(redisCache, options);</span>
<span class="cstat-no" title="statement not covered" >}</span>
&nbsp;
// TODO: coverage
/**
 * redisCache should be connected
 */
export <span class="fstat-no" title="function not covered" >function redisClusterInsStore(</span>
<span class="cstat-no" title="statement not covered" >  redisCache: RedisClusterType,</span>
<span class="cstat-no" title="statement not covered" >  options: RedisClusterOptions &amp; Config,</span>
<span class="cstat-no" title="statement not covered" >) {</span>
<span class="cstat-no" title="statement not covered" >  const reset = async () =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    await Promise.all(</span>
<span class="cstat-no" title="statement not covered" >      redisCache.getMasters().map(async (node) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if (node.client) {</span>
<span class="cstat-no" title="statement not covered" >          const client = await node.client;</span>
<span class="cstat-no" title="statement not covered" >          await client.flushDb();</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >      }),</span>
<span class="cstat-no" title="statement not covered" >    );</span>
<span class="cstat-no" title="statement not covered" >  };</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  const keys = async (pattern: string) =&gt;</span>
<span class="cstat-no" title="statement not covered" >    (</span>
<span class="cstat-no" title="statement not covered" >      await Promise.all(</span>
<span class="cstat-no" title="statement not covered" >        redisCache.getMasters().map(async (node) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          if (node.client) {</span>
<span class="cstat-no" title="statement not covered" >            const client = await node.client;</span>
<span class="cstat-no" title="statement not covered" >            return await client.keys(pattern);</span>
<span class="cstat-no" title="statement not covered" >          }</span>
<span class="cstat-no" title="statement not covered" >          return [];</span>
<span class="cstat-no" title="statement not covered" >        }),</span>
<span class="cstat-no" title="statement not covered" >      )</span>
<span class="cstat-no" title="statement not covered" >    ).flat();</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  return builder(redisCache, 'redis-cluster', reset, keys, options);</span>
<span class="cstat-no" title="statement not covered" >}</span>
&nbsp;</pre></td></tr></table></pre>
